...
The homepage unit galaxy does not display association lines between spheres. Keep the lower-right controller as a true 3D perspective control with depth, orbit and pitch, not a flat-plan rotation.
